...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default="Results/finetune_layer0_results", help="Directory to save checkpoints and logs.")
    parser.add_argument('--num_epochs', type=int, default=13, help="Number of training epochs.")
    parser.add_argument('--batch_size', type=int, default=4, help="Batch size for training.")
    parser.add_argument('--learning_rate', type=float, default=5e-5, help="Learning rate for the optimizer.")
    parser.add_argument('--local_model_path', type=str, default=None, help="Path to a local pre-trained model directory for fine-tuning.")
